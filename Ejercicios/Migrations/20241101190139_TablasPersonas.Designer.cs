...
namespace Ejercicios.Migrations
{
    ...
    [Migration("20241101190139_TablasPersonas")]
    partial class TablasPersonas
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ejercicios.Models.EjercicioFisico", b =>
                {
            ...
            modelBuilder.Entity("Ejercicios.Models.EventoDeportivo", b =>
                {
                    b.Property<int>("EventoDeportivoID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Ejercicios.Models.Lugar", b =>
                {
                    b.Property<int>("LugarID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Ejercicios.Models.Persona", b =>
                {
                    b.Property<int>("PersonaID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Ejercicios.Models.TipoEjercicio", b =>
                {
                    b.Property<int>("TipoEjercicioID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Ejercicios.Models.EjercicioFisico", b =>
                {
                    b.HasOne("Ejercicios.Models.EventoDeportivo", "EventosDeportivos")
                        .WithMany()
                        .HasForeignKey("EventoDeportivoID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Ejercicios.Models.Lugar", "Lugar")
                        .WithMany("EjercicioFisicos")
                        .HasForeignKey("LugarID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Ejercicios.Models.Persona", "Personas")
                        .WithMany("EjercicioFisicos")
                        .HasForeignKey("PersonaID");

                    b.HasOne("Ejercicios.Models.TipoEjercicio", "TipoEjercicios")
                        .WithMany("EjercicioFisicos")
